# Generated by Django 3.2.13 on 2022-12-09 02:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(choices=[('ECT', '기타'), ('RECOMMEND', '추천·리뷰'), ('BASIC', '기초상식'), ('NEWS', '뉴스'), ('BODO', '보도자료'), ('YEAR', '연말정산')], default='ECT', max_length=20, verbose_name='태그명')),
