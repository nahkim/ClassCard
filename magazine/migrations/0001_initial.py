# Generated by Django 3.2.13 on 2022-12-13 01:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(choices=[('NEWS', '뉴스'), ('BASIC', '기초상식'), ('ECT', '기타'), ('BODO', '보도자료'), ('RECOMMEND', '추천·리뷰'), ('YEAR', '연말정산')], default='ECT', max_length=20, verbose_name='태그명')),
